...
public class FiltroTokensJwt_SS extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		bitacora.trace("doFilterInternal(servletPath:" + request.getServletPath() + ", URI:" + request.getRequestURI()
		...
		if (statusAutenticacionPeticion == PETICION_AUTENTICADA_OK) {
			...
			bitacora.warn("Peticion rechazada de " + request.getRemoteAddr() + ". Respuesta devuelta:" + respuestaJSon);
		}
	}
